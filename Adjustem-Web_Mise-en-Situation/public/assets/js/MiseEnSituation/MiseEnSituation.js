...
function checkKeyDown ( event ) {
	if (event.code == 'Pause') {
		modeAdjustemCrew = true;
	} else {
     modeAdjustemCrew = false;
    }
};
...
document.getElementById("menuiserie").addEventListener("click", function () {
  document.getElementById("btnExportObj").hidden = !modeAdjustemCrew;
});
